...
<?php $__env->startSection('seo'); ?>
    ...
    <title> <?php echo e(trans('portfolio/teached.seo_title')); ?></title>
    <meta name="description" content="<?php echo e(trans('portfolio/teached.seo_descr')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/redesign.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/portfolio/teached.css')); ?>">
<?php $__env->stopSection(); ?>
                ...
                <div class="header__inner">
                    <div class="header__description">
                        ...
                        <div data-wow-delay="0.5s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <?php echo e(trans('portfolio/teached.header_title')); ?>
                       ...
                       <a target="_blank" href="http://teachedspa.com.ua/" rel="nofollow" data-wow-delay="0s"
                            ...
                            <span><?php echo e(trans('portfolio/teached.header_button')); ?></span>
                        </a>
                       </div>
                    </div>
                        ...
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                ...
                                <div class="title__top-wrapper">
                                  <span class="title__bottom color-gradient color-shadow"> <?php echo e(trans('portfolio/teached.main_page2')); ?></span>
                                  <span class="color"><?php echo e(trans('portfolio/teached.main_page1')); ?></span>
                                </div>
                            </span>
                        </div>
                    </div>
              ...
              <div class="col-lg-12 title mb-100">
                  <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                      ...
                      <span class="title__top">
                          ...
                          <div class="title__top-wrapper">
                            <span class="title__bottom color-gradient color-shadow"> <?php echo e(trans('portfolio/teached.features2')); ?></span>
                            <span class="color"><?php echo e(trans('portfolio/teached.features1')); ?></span>
                          </div>
                      </span>
                  </div>
              </div>
                    ...
                    <div class="col-lg-12 title mb-100">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                ...
                                <div class="title__top-wrapper">
                                  <span class="title__bottom color-gradient color-shadow"> <?php echo e(trans('portfolio/teached.typography2')); ?></span>
                                  <span class="color"><?php echo e(trans('portfolio/teached.typography1')); ?></span>
                                </div>
                            </span>
                        </div>
                    </div>
                  ...
                  <div class="col-lg-12 title mb-100">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                ...
                                <div class="title__top-wrapper">
                                  <span class="title__bottom color-gradient color-shadow"> <?php echo e(trans('portfolio/teached.palette2')); ?></span>
                                  <span class="color"><?php echo e(trans('portfolio/teached.palette1')); ?></span>
                                </div>
                            </span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.portfolio-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\UNITED-SOLUTION\resources\views/front/portfolio/teached.blade.php ENDPATH**/ ?>