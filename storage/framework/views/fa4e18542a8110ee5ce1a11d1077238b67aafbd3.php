...
<?php $__env->startSection('seo'); ?>
    ...
    <title><?php echo e(trans('portfolio/unique-ua.seo_title')); ?></title>
    <meta name="description" content="<?php echo e(trans('portfolio/unique-ua.sep_descr')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/redesign.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/portfolio/unique-ua.css')); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <main class="unique-ua">
                    ...
                    <div class="banner__left">
                        <div class="banner__left-content">
                            ...
                            <div data-wow-delay="0.5s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                                ...
                                <?php echo e(trans('portfolio/unique-ua.header_title')); ?>
                            ...
                            <a data-wow-delay="0s" data-wow-duration="2s" data-wow-iteration="1" data-wow-offset="0"
                                ...
                                <?php echo e(trans('portfolio/unique-ua.header_button')); ?>
        ...
        <section class="main-page">
            ...
            <div class="container">
                <span data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                    ...
                    <?php echo trans('portfolio/unique-ua.main_page'); ?>
            ...
            <div class="container">
                <div class="color-solution__inner">
                    <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                        ...
                        <span class="color-solution__heading"><?php echo trans('portfolio/unique-ua.colors'); ?></span>
                    </div>
            ...
            <div class="container">
                <div class="logo-dev__inner">
                    <span data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                        ...
                        <?php echo trans('portfolio/unique-ua.logo'); ?>
            ...
            <div class="container">
                <div class="font-solution__inner">
                    <span data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                        ...
                        <?php echo trans('portfolio/unique-ua.fonts'); ?>
        ...
        <section data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
            ...
            <div class="container">
                <?php echo trans('portfolio/unique-ua.tour'); ?>
        ...
        <section class="calendar">
            <div class="container">
                <span data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                    ...
                    <?php echo trans('portfolio/unique-ua.calendar'); ?>
        ...
        <section class="other-pages">
            <div class="container">
                <span data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                    ...
                    <?php echo trans('portfolio/unique-ua.other_pages'); ?>
...
<?php echo $__env->make('layouts.portfolio-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\UNITED-SOLUTION\resources\views/front/portfolio/unique-ua.blade.php ENDPATH**/ ?>