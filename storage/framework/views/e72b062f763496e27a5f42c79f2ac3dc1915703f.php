    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2 footer__logo">
                <a href="<?php echo e(getLocaleUrl('/')); ?>" class="logo-link">
                ...
                <div class="footer-brief">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo e(getLocaleUrl('brief-style')); ?>" class="small"><?php echo e(trans('partials/footer.firm_style')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2 footer__menu">
                <ul class="pl-20prec">
                    <li>
                        <p class="footer__menu-title"><?php echo e(trans('partials/footer.menu')); ?></p>
                    </li>
                    <li><a href="<?php echo e(getLocaleUrl('portfolio')); ?>"> <?php echo e(trans('partials/footer.projects')); ?> </a></li>
                    <li><a href="#"><?php echo e(trans('partials/footer.vacancies')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('contacts')); ?>"> <?php echo e(trans('partials/footer.contacts')); ?> </a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2 footer__menu  footer__menu-services">
                <ul class="">
                    <li>
                        <p class="footer__menu-title"><?php echo e(trans('partials/footer.services')); ?></p>
                    </li>
                    <li><a href="<?php echo e(getLocaleUrl('razrabotka-sajtov')); ?>"> <?php echo e(trans('partials/footer.site_dev')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('internet-magazin')); ?>"> <?php echo e(trans('partials/footer.e_store_dev')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('razrabotka-saita-vizitki')); ?>"> <?php echo e(trans('partials/footer.site_visit')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('mobapps')); ?>"> <?php echo e(trans('partials/footer.ios_android_app')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('kontekstnaya-reklama')); ?>"> <?php echo e(trans('partials/footer.context_advert')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('seo-optimizatsiya')); ?>"> <?php echo e(trans('partials/footer.seo-optimization')); ?> </a></li>
                    <li><a href="<?php echo e(getLocaleUrl('smm')); ?>"> <?php echo e(trans('partials/footer.smm')); ?> </a></li>
                </ul>
            </div>
            <!-- <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2 footer__menu">
                <ul>
                    <li>
                        <p class="footer__menu-title"> <?php echo e(trans('partials/footer.contacts')); ?> </p>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="address_item">
                            ...
                            <p>
                                <?php echo e(trans('partials/footer.adress')); ?>
                    ...
                    <li>
                        <div class="address_item">
                            ...
                            <p>
                                <?php echo trans('partials/footer.work_schedule'); ?>
        ...
        <div class="row">
            <div class="col-xs-12">
                <p class="copy">
                    <?php echo e(trans('partials/footer.rights')); ?>
...
<script type="application/ld+json">
  {
    ...
    "name": "MobIOS Studio",
    "url": "https://mobios.ua/",
    "logo": "<?php echo e(Request::url()); ?>/img/logo.png",
...
<?php /**PATH E:\laragon\www\UNITED-SOLUTION\resources\views/partials/redesign/footer.blade.php ENDPATH**/ ?>