...
<?php $__env->startSection('seo'); ?>
    <title><?php echo e(trans('website.seo_title')); ?></title>
    <meta name="description" content="<?php echo e(trans('website.seo_description')); ?>">
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?php echo e(trans('website.seo_title')); ?>">
    <meta property="og:url" content="<?php echo e(Request::url()); ?>" />
    <meta property="og:site_name" content="<?php echo e(trans('website.seo_name')); ?>" />
    <meta property="og:description" content="<?php echo e(trans('website.seo_description')); ?>" />
...
<?php $__env->startSection('content'); ?>
    <main class="main webs">
        <?php
            $indexBanner = [
                'title' => trans('website.title'),
                'subtext' => trans('website.subtext'),
                'type' => 'webDev',
                'crumbs' => [['text' => trans('website.crumbs')]],
            ];

        ?>
        <?php echo $__env->make('partials.redesign.index-banner', $indexBanner, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php
            $we_propouse = [
                'items' => [
                    [
        ...
        <section class="process">
            <div class="container">
                <div class="process__inner">
                    <div class="section-title"><?php echo e(trans('website.section_title')); ?></div>
                    <div class="process-steps">
                        <div class="process-steps__item">
                            ...
                            <img width="105" height="105" class="wow fadeInLeft delay-1s lazy"
                                data-src="/img/icons/razrabotka-sajtov/step1.svg" alt="step 1">
                            <div class="process-steps__content wow fadeInLeft delay-2s">
                                <div class="process-steps__title">
                                    <?php echo trans('website.stage_title1'); ?>

                                </div>
                                <div class="process-steps__text"><?php echo e(trans('website.stage_descr1')); ?></div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            <div class="process-steps__number wow fadeInUp">2</div>
                            <img width="105" height="105" class="lazy wow fadeInRight delay-1s"
                                data-src="/img/icons/razrabotka-sajtov/step2.svg" alt="step 2">
                            <div class="process-steps__content wow fadeInRight delay-2s">
                                <div class="process-steps__title"><?php echo e(trans('website.stage_title2')); ?></div>
                                <div class="process-steps__text"><?php echo e(trans('website.stage_descr2')); ?></div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            <div class="process-steps__number wow fadeInUp">3</div>
                            <img width="105" height="105" class="lazy wow fadeInLeft delay-1s"
                                data-src="/img/icons/razrabotka-sajtov/step3.svg" alt="step 3">
                            <div class="process-steps__content wow fadeInLeft delay-2s">
                                <div class="process-steps__title"><?php echo e(trans('website.stage_title3')); ?></div>
                                <div class="process-steps__text"><?php echo e(trans('website.stage_descr3')); ?></div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            <div class="process-steps__number wow fadeInUp">4</div>
                            <img width="105" height="105" class="lazy wow fadeInRight delay-1s"
                                data-src="/img/icons/razrabotka-sajtov/step4.svg" alt="step 4">
                            <div class="process-steps__content wow fadeInRight delay-2s">
                                <div class="process-steps__title"><?php echo e(trans('website.stage_title4')); ?></div>
                                <div class="process-steps__text"><?php echo e(trans('website.stage_descr4')); ?></div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            <div class="process-steps__number wow fadeInUp">5</div>
                            <img width="105" height="105" class="lazy wow fadeInLeft delay-1s"
                                data-src="/img/icons/razrabotka-sajtov/step5.svg" alt="step 5">
                            <div class="process-steps__content wow fadeInLeft delay-2s">
                                <div class="process-steps__title"><?php echo e(trans('website.stage_title5')); ?></div>
                                <div class="process-steps__text"><?php echo e(trans('website.stage_descr5')); ?></div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            <div class="process-steps__number wow fadeInUp">6</div>
                            <img width="105" height="105" class="lazy wow fadeInRight delay-1s"
                                data-src="/img/icons/razrabotka-sajtov/step6.svg" alt="step 6">
                            <div class="process-steps__content wow fadeInRight delay-2s">
                                <div class="process-steps__title"><?php echo e(trans('website.stage_title6')); ?></div>
                                <div class="process-steps__text"><?php echo e(trans('website.stage_descr6')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php echo $__env->make('partials.ask', ['formClass' => 'razrabotka-sajtov'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php
            $we_propouse = [
                'section_title' => [
        ...
        <section class="projects projects_redesign">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <?php $section_title =  ['title' => trans('index.main_section_title') ]; ?> <?php echo $__env->make('partials.redesign.parts.section_title-button', $section_title, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                <div class="row projects_redesign-loop">
                    <div class="col-xs-12">
                        <p
                            ...
                            <?php echo e(trans('website.projects_subtitle')); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\UNITED-SOLUTION\resources\views/front/website.blade.php ENDPATH**/ ?>