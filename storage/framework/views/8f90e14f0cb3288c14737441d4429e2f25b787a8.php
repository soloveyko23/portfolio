...
<?php $__env->startSection('seo'); ?>
    ...
    <title> <?php echo e(trans('portfolio/slavicmeet.seo_title')); ?></title>
    <meta name="description" content="<?php echo e(trans('portfolio/slavicmeet.seo_descr')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/redesign.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/portfolio/slavicmeet.css')); ?>">
<?php $__env->stopSection(); ?>
                ...
                <div class="header__inner">
                    <div class="header__description">
                        ...
                        <div data-wow-delay="0.5s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <?php echo e(trans('portfolio/slavicmeet.header_title')); ?>
                       ...
                       <a target="_blank" href="http://slavicmeetspa.com.ua/" rel="nofollow" data-wow-delay="0s"
                            ...
                            <span><?php echo e(trans('portfolio/slavicmeet.header_button')); ?></span>
                        </a>
                       </div>
                    </div>
                    ...
                    <div class="col-lg-12 title mb-100">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                ...
                                <span class="color"><?php echo e(trans('portfolio/slavicmeet.main_page1')); ?></span>
                            </span>
                        </div>
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            class="wow fadeInRight title-right">
                            <span class="title__bottom color-gradient color-shadow"> <?php echo e(trans('portfolio/slavicmeet.main_page2')); ?></span>
                        </div>
                    </div>
                    <div class="col-lg-12">
                  ...
                  <div class="col-lg-12 title mb-100">
                          <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                              ...
                              <span class="title__top">
                                  ...
                                  <span class="color color-dark"><?php echo e(trans('portfolio/slavicmeet.landingPage1')); ?></span>
                              </span>
                          </div>
                          <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                              class="wow fadeInRight title-right">
                              <span class="title__bottom color-white"> <?php echo e(trans('portfolio/slavicmeet.landingPage2')); ?></span>
                          </div>
                      </div>
                  </div>
                </div>
                ...
                <div class="col-lg-12 title mb-100">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                ...
                                <span class="color color-white"><?php echo e(trans('portfolio/slavicmeet.brand1')); ?></span>
                            </span>
                        </div>
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            class="wow fadeInRight title-right">
                            <span class="title__bottom color-gradient"> <?php echo e(trans('portfolio/slavicmeet.brand2')); ?></span>
                        </div>
                    </div>
                </div>
              </div>
                    ...
                    <div class="col-lg-12 title mb-100">
                      <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                          ...
                          <span class="title__top">
                              ...
                              <span class="color color-dark"><?php echo e(trans('portfolio/slavicmeet.typography1')); ?></span>
                          </span>
                      </div>
                      <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                          class="wow fadeInRight title-right">
                          <span class="title__bottom color-gradient"> <?php echo e(trans('portfolio/slavicmeet.typography2')); ?></span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-lg-12 title mb-100">
                      <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                          ...
                          <span class="title__top">
                              ...
                              <span class="color color-dark"><?php echo e(trans('portfolio/slavicmeet.palette1')); ?></span>
                          </span>
                      </div>
                      <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                          class="wow fadeInRight title-right">
                          <span class="title__bottom color-gradient"> <?php echo e(trans('portfolio/slavicmeet.palette2')); ?></span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-lg-12 title mb-100">
                      <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                          ...
                          <span class="title__top">
                              ...
                              <span class="color color-dark"><?php echo e(trans('portfolio/slavicmeet.error1')); ?></span>
                          </span>
                      </div>
                      <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                          class="wow fadeInRight title-right">
                          <span class="title__bottom color-gradient"> <?php echo e(trans('portfolio/slavicmeet.error2')); ?></span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="thanks__container container">
            <div class="thanks__content">
              <div class="thanks__left">
                <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                    class="wow fadeIn">
                    <span class="thanks__title __title color-gradient"><?php echo e(trans('portfolio/slavicmeet.footer1')); ?></span>
                </div>
                <div data-wow-delay="0.4s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                    class="wow fadeIn">
                    <span class="thanks__title __sub"><?php echo e(trans('portfolio/slavicmeet.footer2')); ?></span>
                </div>
                <div data-wow-delay="0.4s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                    class="wow fadeIn">
                    <span class="thanks__title __sub"><?php echo e(trans('portfolio/slavicmeet.footer3')); ?></span>
                </div>
              </div>
...
<?php echo $__env->make('layouts.portfolio-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\UNITED-SOLUTION\resources\views/front/portfolio/slavicmeet.blade.php ENDPATH**/ ?>