<section class="results">
    <div class="container">
        <div class="section-title">
            Результаты <span class="phone-hidden">наших</span> клиентов
            <span class="section-title-sub">
                А давайте взглянем на результаты наших клиентов в цифрах?
                <span>Они многое могут сказать о том, чего мы смогли вместе достичь!</span>
            </span>
        </div>
        <div class="posr">
                                        ...
                                        <div class="item__cell__footer">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <ul class="item__tech">
                                                        <li><img class="lazy" width="111" height="27"
                                                                data-src="/img/tech/laravel.png" alt="laravel"></li>
                                                        <li><img class="lazy" width="90" height="27"
                                                                data-src="/img/tech/vue.png" alt="vue"></li>
                                                        <li><img class="lazy" width="102" height="27"
                                                                data-src="/img/tech/bootstrap.png" alt="bootstrap"></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                ...
                <ul class="item__results">
                  ...
                  <li>
                    ...
                    <p class="item__results-descr">увеличился трафик за <b>ГОД</b></p>
                            ...
                            @endif
                            <button class="button button__green button__green-solid margin-auto"
                                style="margin-top: 20px" data-togle="#popoup-2">
                                Подробнее о проекте
                            </button>
                        </div>
                    </div>
                ...
                <div class="results__slide">
                    <div class="item">
                                        ...
                                        <div class="item__cell__footer">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12">
                                                    <p class="text__bold">Технологии:</p>
                                                    <ul class="item__tech">
                                                        <li><img class="lazy" width="140" height="27"
                                                                data-src="/img/tech/opencart.png" alt="opencart"></li>
                                                        <li><img class="lazy" width="118" height="27"
                                                                data-src="/img/tech/jquery.png" alt="jquery"></li>
                                                        <li><img class="lazy" width="102" height="27"
                                                                data-src="/img/tech/bootstrap.png" alt="bootstrap"></li>
                                                    </ul>
                                                </div>
                        ...
                        <div class="item__footer">
                            ...
                            <button class="button button__green button__green-solid margin-auto"
                                style="margin-top: 20px" data-togle="#popoup-1">
                                Подробнее о проекте
                            </button>
                        </div>
                    </div>
                ...
                <div class="results__slide">
                    <div class="item">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-offset-1">
                                ...
                                <div class="item__poster">
                                    <picture>
                                        ...
                                        <img width="824" height="506"
                                            data-src="/img/results/colgotof_poster.png" alt="colgotof_poster"
                                            class="lazy desctop">
                                    </picture>
                                </div>
                            </div>
                        ...
                        <div class="item__footer">
                            ...
                            <button class="button button__green button__green-solid margin-auto"
                                style="margin-top: 20px" data-togle="#popoup-3">
                                Подробнее о проекте
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="item__footer">
                        ...
                        <ul class="item__stages">
                            ...
                            <li>
                                ...
                                <p>
                                    2. Разработка <br> маркетинговой стратегии
                                </p>
                            </li>
                            <li>
                                <div class="decor"></div>
                                ...
                                <p>
                                    3. Проектирование <br> интерфейса
                                </p>
                            </li>
                            <li>
                                <div class="decor"></div>
                            ...
                            <li>
                                ...
                                <p>
                                    6. Написание Front-end <br> и Back-end части
                                </p>
                            </li>
                        </ul>
                        ...
                        <div class="item__section">
                            ...
                            <div class="item__section-cont">
                                ...
                                <div class="item__section-wind">
                                    ...
                                    <p><span>18 195</span> визитов</p>
                                    <p>от <span>32</span> заказов в день</p>
                                    <p><span>2 011</span> конверсий</p>
                                </div>
                            </div>
                        </div>
                        <div class="item__section item__section-orange">
                            ...
                            <div class="item__section-cont">
                                ...
                                <div class="item__section-wind">
                                    <p class="bold">за ноябрь 2020:</p>
                                    <p><span>677</span> запросов в ТОП-3</p>
                                    <p><span>1 266</span> в ТОП-10</p>
                                    <p><span>1 807</span> в ТОП-30</p>
                                </div>
                            </div>
                        </div>
                        <div class="item__section item__section-green">
                            ...
                            <div class="item__section-cont">
                                <div class="item__section-image">
                                    ...
                                    <p class="item__section-image__text">
                                        период: ноябрь 2019 — ноябрь 2020
                                    </p>
                                </div>
                                <div class="item__section-wind">
                                    <p class="bold">за ноябрь 2020:</p>
                                    <p><span>371</span> домен</p>
                                    <p><span>1 524</span> страницы</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="item__footer">
                        ...
                        <div class="item__section">
                            ...
                            <div class="item__section-cont">
                                <div class="item__section-image">
                                    <img class="lazy" data-src="/img/results/hoasklad__graph-1.png"
                                        alt="hoasklad__graph-1">
                                    <p class="item__section-image__text">
                                        период: август 2020 — ноябрь 2020
                                    </p>
                                </div>
                        ...
                        <div class="item__section item__section-green">
                            ...
                            <div class="item__section-cont">
                                <div class="item__section-image">
                                    <img class="lazy" data-src="/img/results/hoasklad__graph-2.png"
                                        alt="hoasklad__graph-2">
                                    <p class="item__section-image__text">
                    ...
                    <div class="item__footer">
                        ...
                        <div class="item__section">
                            ...
                            <div class="item__section-cont">
                                ...
                                <div class="item__section-wind">
                                    <p class="bold">за ноябрь 2020:</p>
                                    <p><span>203</span> визитов</p>
                                    <p>от <span>10</span> заказов в день</p>
                                    <p><span>1 200</span> конверсий</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item__section item__section-orange">
                            ...
                            <div class="item__section-cont">
                                <div class="item__section-image">
                                    <img class="lazy" data-src="/img/results/kolg__graphic-2.png"
                                        alt="kolg__graphic-2">
                                    <p class="item__section-image__text">
                                        период: апрель 2020 — сентябрь 2020
                                    </p>
                                </div>
                                <div class="item__section-wind">
                                    <p class="bold">за сентябрь 2020:</p>
                                    <p><span>237</span>запросов в ТОП-3</p>
                                    <p><span>548</span> в ТОП-10</p>
                                    <p><span>1 048</span> в ТОП-30</p>
                                </div>
                            </div>
                        </div>
                        <div class="item__section item__section-green">
                            ...
                            <div class="item__section-cont">
                                <div class="item__section-image">
                                    <img class="lazy" data-src="/img/results/kolg__graphic-3.png"
                                        alt="kolg__graphic-3">
                                    <p class="item__section-image__text">
                                        период: январь 2019 — апрель 2021
                                    </p>
                                </div>
                                <div class="item__section-wind">
                                    <p class="bold">за апрель 2021:</p>
                                    <p><span>330</span>доменов</p>
                                    <p><span>4 014</span>страниц</p>
                                </div>
                            </div>
                        </div>
                    </div>
