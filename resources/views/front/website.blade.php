...
@section('content')
    <main class="main webs">
        ...
        <section class="process">
            <div class="container">
                <div class="process__inner">
                    <div class="section-title">{{ trans('website.section_title') }}</div>
                        ...
                        <div class="process-steps__item">
                            ...
                            <div class="process-steps__content wow fadeInLeft delay-2s">
                                <div class="process-steps__title">
                                    {!! trans('website.stage_title1') !!}
                                </div>
                                <div class="process-steps__text">{{ trans('website.stage_descr1') }}</div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            ...
                            <div class="process-steps__content wow fadeInRight delay-2s">
                                <div class="process-steps__title">{{ trans('website.stage_title2') }}</div>
                                <div class="process-steps__text">{{ trans('website.stage_descr2') }}</div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            ...
                            <div class="process-steps__content wow fadeInLeft delay-2s">
                                <div class="process-steps__title">{{ trans('website.stage_title3') }}</div>
                                <div class="process-steps__text">{{ trans('website.stage_descr3') }}</div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            ...
                            <div class="process-steps__content wow fadeInRight delay-2s">
                                <div class="process-steps__title">{{ trans('website.stage_title4') }}</div>
                                <div class="process-steps__text">{{ trans('website.stage_descr4') }}</div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            ...
                            <div class="process-steps__content wow fadeInLeft delay-2s">
                                <div class="process-steps__title">{{ trans('website.stage_title5') }}</div>
                                <div class="process-steps__text">{{ trans('website.stage_descr5') }}</div>
                            </div>
                        </div>
                        <div class="process-steps__item">
                            ...
                            <div class="process-steps__content wow fadeInRight delay-2s">
                                <div class="process-steps__title">{{ trans('website.stage_title6') }}</div>
                                <div class="process-steps__text">{{ trans('website.stage_descr6') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @include('partials.ask', ['formClass' => 'razrabotka-sajtov'])
        @php
            $we_propouse = [
                'section_title' => [
                ...
                <div class="row projects_redesign-loop">
                    <div class="col-xs-12">
                        <p
                            ...
                            {{ trans('website.projects_subtitle') }}
                        </p>
                    </div>
