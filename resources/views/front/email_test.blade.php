...
@if ($brief_type == 'brief-style')
  ...
  @for($i = 1; $i < 36; $i++)
    @if (!in_array($i,[6,9,11,14,26,27,28,33]))
      @php
          $count++
      @endphp
      @if($count%2) <tr> @else <tr style="background-color: #f8f8f8;"> @endif
    ...
    @elseif($i == 26)
      ...
      @if($count%2) <tr> @else <tr style="background-color: #f8f8f8;"> @endif
        ...
        <td style='padding: 10px; border: #e9e9e9 1px solid;'> <img src="{{ $arrPics[26][$fields[$i]] }}"></td>
      </tr>
    @elseif($i == 28){
      @php
        $count++
