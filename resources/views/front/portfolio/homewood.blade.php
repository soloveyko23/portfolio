...
@section('seo')
    ...
    <title> {{ trans('portfolio/homewood.seo_title') }}</title>
    <meta name="description" content="{{ trans('portfolio/homewood.seo_descr') }}">
@endsection

@section('css')
    <link rel="stylesheet" href="{{ asset('css/redesign.css') }}">
    <link rel="stylesheet" href="{{ asset('css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('css/portfolio/homewood.css') }}">
@endsection
@section('content')
                ...
                <div class="header__inner">
                    <div class="header__description">
                        ...
                        <div data-wow-delay="0.5s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            {{ trans('portfolio/homewood.header_title') }}
                        </div>
                        <div data-wow-delay="0.5s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                        ...
                        <a target="_blank" href="http://homewoodspa.com.ua/" rel="nofollow" data-wow-delay="0s"
                            ...
                            {{ trans('portfolio/homewood.header_button') }}
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 title">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                <p>01.</p>
                                {{ trans('portfolio/homewood.main_page1') }}
                            </span>
                        </div>
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            class="wow fadeInRight">
                            <span class="title__bottom"> {{ trans('portfolio/homewood.main_page2') }}</span>
                        </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 title">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                <p>02.</p>
                                {{ trans('portfolio/homewood.grid1') }}
                            </span>
                        </div>
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            class="wow fadeInRight">
                            <span class="title__bottom"> {{ trans('portfolio/homewood.grid2') }}</span>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            class="wow fadeIn colsystem__sub-title">
                            <span> {{ trans('portfolio/homewood.grid3') }} </span>
                        </div>
                        ...
                        <div class="colsystem__image">
                            <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                                ...
                                <span> {{ trans('portfolio/homewood.grid4') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 title">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                <p>03.</p>
                                {{ trans('portfolio/homewood.colors') }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 title">
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            ...
                            <span class="title__top">
                                <p>04.</p>
                                {{ trans('portfolio/homewood.others1') }}
                            </span>
                        </div>
                        <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                            class="wow fadeInRight">
                            <span class="title__bottom">{{ trans('portfolio/homewood.others2') }}</span>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div data-wow-delay="0s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                        ...
                        <span class="thankyou__title">{{ trans('portfolio/homewood.footer1') }}</span>
                    </div>
                    <div data-wow-delay="0.4s" data-wow-duration="1s" data-wow-iteration="1" data-wow-offset="0"
                        class="wow fadeIn lastpage__iamge">
                        <span class="thankyou__sub">{{ trans('portfolio/homewood.footer2') }}</span>
                    </div>
                ...
                <div class="col-xs-12">
                    <div class="btn-prew-site">
                        <a rel="nofollow" href="http://homewoodspa.com.ua/"
                            class="prewSite">{{ trans('portfolio/homewood.footer3') }}</a>
                    </div>
                </div>
            </div>
        </section>
