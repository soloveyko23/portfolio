...
@section('seo')
    ...
    <title>{{ trans('portfolio/equis.seo_title') }}</title>
    <meta name="description" content="{{ trans('portfolio/equis.seo_descr') }}">
@endsection

@section('css')
    <link rel="stylesheet" href="{{ asset('css/redesign.css') }}">
    <link rel="stylesheet" href="{{ asset('css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('css/portfolio/equis.css') }}">
@endsection
                ...
                <div class="header__inner">
                    <div class="header__description">
                        ...
                        <h1 class="header__txt wow bounceInLeft">
                            {{ trans('portfolio/equis.header_title') }}
                        </h1>
                        <div class="header__icons">
                            ...
                            <a href="https://equis-group.com/" class="header__button bounceInLeft" rel="nofollow">
                                {{ trans('portfolio/equis.header_button') }}
                            </a>
                        </div>
                    </div>
                </div>
