...
@section('seo')
    <title>{{ trans('smm.seo_title') }}</title>
    <meta name="description" content="{{ trans('smm.seo_descr') }}">
@endsection

@section('css')
    <link rel="stylesheet" href="{{ asset('css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('css/smm.css') }}">
...
@section('content')
    <main class="main smm">
                                ...
                                <ul class="bread-crumbs__list" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    <li class="bread-crumbs__list-item" itemprop="itemListElement" itemscope
                                        ...
                                        <a href="{{ url('/') }}" class="bread-crumbs__link" itemprop="item">
                                            <span itemprop="name">{{ trans('smm.crumbs_main') }}</span>
                                    ...
                                    <li class="bread-crumbs__list-item" itemprop="itemListElement" itemscope
                                        ...
                                        <span class="bread-crumbs__current-page"
                                            itemprop="name">{{ trans('smm.crumbs_page') }}</span>
        ...
        @include('partials.whats-smm')
        @include('partials.complex-desigin')
        @include('partials.trust-us')
        @include('partials.ask', ['formClass' => 'ecommerce'])

        <section class="steps white" style="padding-bottom: 0px">
            <div class="container">
                <div class="section-title">
                    {{ trans('smm.stages_title') }}
                </div>
                <div class="steps__columns steps__columns-slider">
                    <div class="steps__column">
                        <div class="steps__title">
                            {{ trans('smm.steps_title1') }}
                        </div>
        ...
        @include('partials.contact-us', ['formClass' => 'homepage'])
